...
// ---------------------------------------------------------------------------
// Sous-composants UI réutilisables (propres à cette vue)
// ---------------------------------------------------------------------------
        ...
        <main className="flex-1 px-6 py-6">
          ...
          <div className="mb-6 border-l-4 border-[#0B3C53] pl-3">
            ...
            <p className="mt-1 text-[13px] text-slate-500">
              Gérez les utilisateurs, les entreprises et les paramètres de la
              plateforme.
            </p>
          </div>

          {/* Onglets */}
          <div className="mb-6 flex gap-1 rounded-xl border border-slate-200 bg-white p-1.5 shadow-sm w-fit">
            {TABS.map((tab) => (
              <button
                key={tab.key}
...
function UtilisateursTab() {
  ...
  async function handleAddAffectation(e: FormEvent) {
    ...
    try {
      ...
      // Reload l'utilisateur pour voir ses nouvelles affectations
          ...
          <div className="space-y-5">
            ...
            <div className="border-t border-slate-100 pt-4">
              ...
              >
                ...
                <div className="flex-1">
                  <Field label="Valeur (nom du quartier / commune / région)">
                    <Input
                ...
                <button
                  type="submit"
                  className="flex items-center gap-1.5 rounded-lg bg-cyan-600 px-3 py-2 text-[13px] font-semibold text-white hover:bg-cyan-700"
                >
                  <Plus className="h-4 w-4" />
                  Ajouter
                </button>
...
function ParametresTab() {
  ...
  function handleSave() {
    // Simulation sauvegarde locale (ici on pourrait appeler /api/parametres/)
    setSaved(true);
      ...
      <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
        ...
        <div className="divide-y divide-slate-100">
          {filtered.map((p) => (
            <div
              key={p.cle}
              className="flex items-start gap-6 px-5 py-4 hover:bg-slate-50/50"
            >
